...
const firebaseConfig = {
    apiKey: 'AIzaSyBZO9JGDdl4B5PYuI0pu1Wnj8pgMSxNeag',
    authDomain: 'gdsynclist.firebaseapp.com',
    projectId: 'gdsynclist',
    storageBucket: 'gdsynclist.appspot.com',
    messagingSenderId: '881973045910',
    appId: '1:881973045910:web:7c48e02e5e370b39f530b7'
};
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    async function renderAdmin() {
        if (!hasRole(currentUser, 'mod')) {
            $('#view-admin').innerHTML = '<div class="p-4">No access.</div>';
            return;
        }
